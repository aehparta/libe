...
const uint8_t _s_box[256] PROGMEM = {
...
const uint8_t _s_box_inverse[256] PROGMEM = {
...
const uint8_t _rcon[10] PROGMEM = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36 };
