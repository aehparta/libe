...
#define os_gpio_enable(pin, direction) \
	do { \
		if (0) {} \
		else _PIN_IF_A(pin, !direction, TRIS) \
		else _PIN_IF_B(pin, !direction, TRIS) \
		else _PIN_IF_C(pin, !direction, TRIS) \
		else _PIN_IF_D(pin, !direction, TRIS) \
		else _PIN_IF_E(pin, !direction, TRIS) \
		else _PIN_IF_F(pin, !direction, TRIS) \
	} while(0)
...
#define os_gpio_set(pin, state) \
	do { \
		if (0) {} \
		else _PIN_IF_A(pin, state, PORT) \
		else _PIN_IF_B(pin, state, PORT) \
		else _PIN_IF_C(pin, state, PORT) \
		else _PIN_IF_D(pin, state, PORT) \
		else _PIN_IF_E(pin, state, PORT) \
		else _PIN_IF_F(pin, state, PORT) \
	} while (0)
#endif

// static inline void os_gpio_sett(uint8_t pin, bool state)
// {
// 	switch (pin >> 3) {
...
#define os_gpio_pullup(pin, enable) \
	do { \
		if (0) {} \
		else _PIN_IF_A(pin, enable, WPU) \
		else _PIN_IF_B(pin, enable, WPU) \
		else _PIN_IF_C(pin, enable, WPU) \
		else _PIN_IF_D(pin, enable, WPU) \
...
#define os_gpio_open_drain(pin, enable) \
	do { \
		if (0) {} \
		else _PIN_IF_A(pin, enable, ODCON) \
		else _PIN_IF_B(pin, enable, ODCON) \
		else _PIN_IF_C(pin, enable, ODCON) \
		else _PIN_IF_D(pin, enable, ODCON) \
